...
> **Status**: 203 API routes, 178 tests, 67 modules — msg conv read gates (userID + friend/group svc); getMsg group membership; revoke hash-only; miku_rpc_client; RPC internalToken gate; object ACL.
