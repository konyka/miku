...
> **Status**: 203 API routes, 171 tests, 67 modules — token revoke O(1) hash + msggw free-slot stack; msg_store/offline/msg/WS/HTTP/push/conversation/friend/group/user/ratelimit/seq/incr O(1); S3 cron still stub.
