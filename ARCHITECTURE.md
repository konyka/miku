...
> **Status**: 203 API routes, 171 tests, 67 modules — HTTP actor fields bound to token (msg/group/friend/conv); WS sendID bound; group membership/owner gates; all hashed; S3 cron still stub.
