...
> **Status**: 203 API routes, 171 tests, 67 modules — invite requires membership; force_logout bound to token; HTTP/WS actors bound; group owner gates; all hashed; S3 cron still stub.
