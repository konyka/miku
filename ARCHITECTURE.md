...
> **Status**: 203 API routes, 171 tests, 67 modules, 13 binaries, 7 RPC services — friend/group O(1) hash + per-group member chains; ratelimit/user/seq hash; READ receipt fanout; S3 cron still stub.
