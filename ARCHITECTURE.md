...
> **Status**: 203 API routes, 171 tests, 67 modules — friend import/respond/update bind token owner; setGroupInfo admin-gated; actors bound; all hashed; S3 cron still stub.
