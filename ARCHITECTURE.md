...
> **Status**: 203 API routes, 171 tests, 67 modules — si_ length-prefix (underscore-safe); invite-only join; mutual-friend invite; admin stats/shutdown; importFriend admin-only; history gated; S3 stub.
