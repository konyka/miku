...
> **Status**: 203 API routes, 171 tests, 67 modules — msg_store conv chains + offline push token hash; msg/WS/HTTP/push/conversation/friend/group/user/ratelimit/seq/incr O(1); S3 cron still stub.
