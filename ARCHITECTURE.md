...
> **Status**: 203 API routes, 169 tests, 64 modules, 13 binaries, 7 RPC services — group PUSH fanout via foreach (no 512 cap); HTTP group send_msg; gateway seq adopt; quit/kick remove sync; kick+revoke; si_ conv IDs; S3 cron still stub.
