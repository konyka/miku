...
> **Status**: 203 API routes, 171 tests, 67 modules — getActiveConversations + uncapped owner-chain lists; msg delete rebuild (keep seq order); all RPC/API/JSON hashed; S3 cron still stub.
