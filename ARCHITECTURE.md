...
> **Status**: 203 API routes, 171 tests, 67 modules — invite-only join; mutual-friend invite; admin stats/shutdown; importFriend admin-only; kick role hierarchy; history gated; S3 stub.
