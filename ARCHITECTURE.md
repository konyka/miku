...
> **Status**: 203 API routes, 171 tests, 67 modules — sendSimpleMsg pushes/upserts; deleteMsg requires sender; userClearAllMsg skips group history; blacklist on send; all hashed; S3 cron still stub.
