...
> **Status**: 203 API routes, 183 tests, 67 modules — msg send friend/group gate at service layer; delete/revoke conv gate; userClearAllMsg friend gate; msg conv read gates; RPC internalToken gate.
