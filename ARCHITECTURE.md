...
> **Status**: 203 API routes, 171 tests, 67 modules — WS sendID bound to session; group send requires membership; dismiss/transfer/kick owner-gated; all hashed; S3 cron still stub.
