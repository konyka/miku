...
> **Status**: 203 API routes, 184 tests, 67 modules — send-status conv gate; getMsg conv gate; cleanUpMsg/batchSendMsg admin-only; msg send service gate; RPC internalToken gate.
