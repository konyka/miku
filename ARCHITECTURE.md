...
> **Status**: 203 API routes, 184 tests, 67 modules — getMsg conv gate; cleanUpMsg/batchSendMsg admin-only; clearConversationMsg conv gate; msg send service gate; RPC internalToken gate.
