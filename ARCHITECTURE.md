...
> **Status**: 203 API routes, 171 tests, 67 modules — pullMsgBySeq binary/conv + delivery sid incremental + msg_store conv unlink; WS/msggw/pipeline/friend/push/discovery/token indexed; S3 cron still stub.
