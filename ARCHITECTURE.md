...
> **Status**: 203 API routes, 181 tests, 67 modules — markMsgAsRead conv gate; deleteMsgPhysical conv gate; getSendMsgStatus sender-only; msg conv read gates; miku_rpc_client TCP e2e; RPC internalToken gate.
