...
> **Status**: 203 API routes, 167 tests, 64 modules, 13 binaries, 7 RPC services — group quit/kick remove sync; API member add sync; kick+revoke; platform kick; si_ conv IDs; HTTP→WS deliver; S3 cron still stub.
