...
> **Status**: 203 API routes, 171 tests, 67 modules, 13 binaries, 7 RPC services — conversation/friend/group/user/ratelimit/seq O(1) hash; per-group member chains; S3 cron still stub.
