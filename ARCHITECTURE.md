...
> **Status**: 203 API routes, 183 tests, 67 modules — API send fail-closed without friend/group svc; msg send service gate; delete/revoke conv gate; msg conv read gates; RPC internalToken gate.
