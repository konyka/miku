...
> **Status**: 203 API routes, 171 tests, 67 modules — batch delete_friend binds owner; friend list prefers ownerUserID; /msg/send gated; all hashed; S3 cron still stub.
