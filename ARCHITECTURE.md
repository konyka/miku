...
> **Status**: 203 API routes, 171 tests, 67 modules — HTTP+WS history reads require conversation participant; list-reads token-bound; all hashed; S3 cron still stub.
