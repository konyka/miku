...
> **Status**: 203 API routes, 183 tests, 67 modules — clearConversationMsg conv gate unified; API send fail-closed; msg send service gate; delete/revoke conv gate; RPC internalToken gate.
