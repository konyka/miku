...
> **Status**: 203 API routes, 171 tests, 67 modules — setConversation userID→owner; uncap friend/group/msg lists; pin/delete/full conv IDs; black list fields; all RPC/API/JSON hashed; S3 cron still stub.
