...
> **Status**: 203 API routes, 171 tests, 67 modules — split WS blacklist sync; send ignores client conversationID; si_ length-prefix; invite-only join; mutual-friend invite; admin gates; history gated; S3 stub.
