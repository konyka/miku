...
> **Status**: 203 API routes, 171 tests, 67 modules — physical delete requires sender; clearConversationMsg participant-gated; actors bound; all hashed; S3 cron still stub.
