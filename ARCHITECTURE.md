...
> **Status**: 203 API routes, 171 tests, 67 modules — userClearAllMsg scoped to user; clearConversationMsg real delete; transferGroupOwner; all hashed; S3 cron still stub.
