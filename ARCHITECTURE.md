...
> **Status**: 203 API routes, 171 tests, 67 modules — admin stats/shutdown admin-only; importFriend admin-only; kick role hierarchy; friends-only invite; history gated; S3 stub.
