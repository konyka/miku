...
> **Status**: 203 API routes, 168 tests, 64 modules, 13 binaries, 7 RPC services — HTTP sendMsg adopts gateway seq; group quit/kick remove sync; kick+revoke; platform kick; si_ conv IDs; HTTP→WS deliver; S3 cron still stub.
