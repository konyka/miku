...
> **Status**: 203 API routes, 171 tests, 67 modules — all service RPC method hashes (msg/user/friend/group/conv/third); API path/JSON/indexes O(1); S3 cron still stub.
