...
> **Status**: 203 API routes, 171 tests, 67 modules — friend list-by-owner + push online_count; discovery/token/msg_store/msg/WS/HTTP/conversation/group/user/ratelimit/seq/incr O(1); S3 cron still stub.
