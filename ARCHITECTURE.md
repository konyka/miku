...
> **Status**: 203 API routes, 171 tests, 67 modules — WS deliver bumps unread like HTTP; handle_conv accepts ownerUserID; getNotNotifyConversationIDs; all RPC/API/JSON hashed; S3 cron still stub.
