...
> **Status**: 203 API routes, 171 tests, 67 modules — clearConversationMsg requires participant (no group hard-delete); invite/force_logout gated; actors bound; all hashed; S3 cron still stub.
