...
> **Status**: 203 API routes, 168 tests, 64 modules, 13 binaries, 7 RPC services — HTTP group send_msg (groupID); gateway seq adopt; group quit/kick remove sync; kick+revoke; platform kick; si_ conv IDs; HTTP→WS deliver; S3 cron still stub.
