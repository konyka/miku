...
> **Status**: 203 API routes, 171 tests, 67 modules — fix isFriend API fields; implement getJoinedGroupList/getFullJoinGroupIDs; markConversationMessageAsRead clears unread; all RPC/API/JSON hashed; S3 cron still stub.
