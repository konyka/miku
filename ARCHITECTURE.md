...
> **Status**: 203 API routes, 171 tests, 67 modules — blacklist blocks send; createGroup initial members; dismiss syncs gateway; WS parse by len; all hashed; S3 cron still stub.
