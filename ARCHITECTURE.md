...
> **Status**: 203 API routes, 180 tests, 67 modules — getSendMsgStatus sender-only; mark-read conv gates; msg conv read gates; getMsg group membership; miku_rpc_client; RPC internalToken gate.
