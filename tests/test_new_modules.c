...
static void test_msg_send_get_search_delete(void) {
    ...
    miku_json_object_set(search_req, "userID", miku_json_create_str("alice"));
    ...
    miku_json_object_set(newest_req, "userID", miku_json_create_str("alice"));
...
static void test_msg_pull_by_seq_range(void) {
    ...
    miku_json_object_set(pull_req, "userID", miku_json_create_str("u1"));
...
static void test_http_e2e_msg_send_and_search(void) {
    ...
    char newest_no_cid[8192] = {0};
    http_post_with_token(19780, "/msg/newest_seq", token,
        "{}", newest_no_cid, sizeof(newest_no_cid));
    r = miku_json_parse_str(extract_json_body(newest_no_cid));
    mk_assert_not_null(r);
    mk_assert_int_eq(400, (int)miku_json_int(miku_json_get(r, "errCode")));
    miku_json_destroy(r);

    char pull_no_cid[8192] = {0};
    http_post_with_token(19780, "/msg/pull_msg_by_seq", token,
        "{}", pull_no_cid, sizeof(pull_no_cid));
    r = miku_json_parse_str(extract_json_body(pull_no_cid));
    mk_assert_not_null(r);
    mk_assert_int_eq(400, (int)miku_json_int(miku_json_get(r, "errCode")));
    miku_json_destroy(r);

    char clear_no_cid[8192] = {0};
    http_post_with_token(19780, "/msg/clear_conversation_msg", token,
        "{}", clear_no_cid, sizeof(clear_no_cid));
    r = miku_json_parse_str(extract_json_body(clear_no_cid));
    mk_assert_not_null(r);
    mk_assert_int_eq(400, (int)miku_json_int(miku_json_get(r, "errCode")));
    miku_json_destroy(r);
    ...
    r = miku_json_parse_str(extract_json_body(search_no_kw));
    mk_assert_not_null(r);
    mk_assert_int_eq(400, (int)miku_json_int(miku_json_get(r, "errCode")));
    miku_json_destroy(r);

    char send_no_content[8192] = {0};
    http_post_with_token(19780, "/msg/send_msg", token,
        "{\"recvID\":\"r1\"}", send_no_content, sizeof(send_no_content));
    r = miku_json_parse_str(extract_json_body(send_no_content));
    mk_assert_not_null(r);
    mk_assert_int_eq(400, (int)miku_json_int(miku_json_get(r, "errCode")));
    miku_json_destroy(r);

    char send_no_peer[8192] = {0};
    http_post_with_token(19780, "/msg/send_msg", token,
        "{\"content\":\"orphan\"}", send_no_peer, sizeof(send_no_peer));
    r = miku_json_parse_str(extract_json_body(send_no_peer));
    mk_assert_not_null(r);
    mk_assert_int_eq(400, (int)miku_json_int(miku_json_get(r, "errCode")));
    miku_json_destroy(r);

    char raw_send_no_peer[8192] = {0};
    http_post_with_token(19780, "/msg/send", token,
        "{\"content\":\"orphan\"}", raw_send_no_peer, sizeof(raw_send_no_peer));
    r = miku_json_parse_str(extract_json_body(raw_send_no_peer));
    mk_assert_not_null(r);
    mk_assert_int_eq(400, (int)miku_json_int(miku_json_get(r, "errCode")));
    miku_json_destroy(r);

    char simple_no_content[8192] = {0};
    http_post_with_token(19780, "/msg/send_simple_msg", token,
        "{\"recvID\":\"r1\"}", simple_no_content, sizeof(simple_no_content));
    r = miku_json_parse_str(extract_json_body(simple_no_content));
    mk_assert_not_null(r);
    mk_assert_int_eq(400, (int)miku_json_int(miku_json_get(r, "errCode")));
    miku_json_destroy(r);
    ...
    mk_assert_int_eq(3003, (int)miku_json_int(miku_json_get(r, "errCode")));
    miku_json_destroy(r);
    char react_list_bad[8192] = {0};
    http_post_with_token(19780, "/msg/get_message_list_reaction_extensions", tok_x,
        "{\"conversationID\":\"si_2_r1_s1\"}", react_list_bad, sizeof(react_list_bad));
    r = miku_json_parse_str(extract_json_body(react_list_bad));
    mk_assert_not_null(r);
    mk_assert_int_eq(3003, (int)miku_json_int(miku_json_get(r, "errCode")));
    miku_json_destroy(r);
