...
static void test_msg_admin_rpc_gate(void) {
    ...
    miku_json_val_t *biz_ok_resp = miku_json_create_object();
    miku_msg_handle_rpc(msg, "sendBusinessNotification", biz_ok, biz_ok_resp);
    mk_assert_int_eq(0, (int)miku_json_int(miku_json_get(biz_ok_resp, "errCode")));
    miku_json_destroy(biz_ok);
    miku_json_destroy(biz_ok_resp);
...
static void test_msg_rpc_resp_reuse(void) {
    miku_friend_service_t *friends = miku_friend_service_create();
    miku_msg_service_t *msg = miku_msg_service_create();
    miku_msg_service_set_friend_svc(msg, friends);
    mk_assert_int_eq(0, miku_friend_add(friends, "a", "b", ""));
    ...
    miku_json_object_set(ok, "userID", miku_json_create_str("a"));
    miku_json_val_t *resp = miku_json_create_object();
    miku_msg_handle_rpc(msg, "getMsgByConv", ok, resp);
    mk_assert_int_eq(0, (int)miku_json_int(miku_json_get(resp, "errCode")));
    ...
    mk_assert_int_eq(400, (int)miku_json_int(miku_json_get(resp, "errCode")));
    {
        miku_json_val_t *st = miku_json_get(resp, "serverTime");
        mk_assert(!st || miku_json_type(st) == MK_JSON_NULL);
    }

    miku_json_val_t *newest_ok = miku_json_create_object();
    miku_json_object_set(newest_ok, "conversationID", miku_json_create_str(cid));
    miku_json_object_set(newest_ok, "userID", miku_json_create_str("a"));
    miku_msg_handle_rpc(msg, "getNewestSeq", newest_ok, resp);
    mk_assert_int_eq(0, (int)miku_json_int(miku_json_get(resp, "errCode")));
    mk_assert(miku_json_int(miku_json_get(resp, "seq")) > 0);
    miku_json_destroy(newest_ok);
    miku_msg_handle_rpc(msg, "getNewestSeq", bad, resp);
    mk_assert_int_eq(400, (int)miku_json_int(miku_json_get(resp, "errCode")));
    {
    ...
    miku_json_object_set(pull, "conversationID", miku_json_create_str(cid));
    miku_json_object_set(pull, "userID", miku_json_create_str("a"));
    miku_json_object_set(pull, "beginSeq", miku_json_create_int(1));
    miku_json_object_set(pull, "endSeq", miku_json_create_int(sent_seq));
    miku_msg_handle_rpc(msg, "pullMsgBySeq", pull, resp);
    mk_assert_int_eq(0, (int)miku_json_int(miku_json_get(resp, "errCode")));
    mk_assert_int_eq(1, (int)miku_json_size(miku_json_get(resp, "data")));
    miku_json_destroy(pull);
    miku_msg_handle_rpc(msg, "pullMsgBySeq", bad, resp);
    mk_assert_int_eq(400, (int)miku_json_int(miku_json_get(resp, "errCode")));
    {
        miku_json_val_t *d = miku_json_get(resp, "data");
        mk_assert(!d || miku_json_type(d) == MK_JSON_NULL);
    ...
    miku_msg_handle_rpc(msg, "unknownMsgRpcMethod", ok, resp);
    mk_assert_int_eq(404, (int)miku_json_int(miku_json_get(resp, "errCode")));
    {
        miku_json_val_t *d = miku_json_get(resp, "data");
        mk_assert(!d || miku_json_type(d) == MK_JSON_NULL);
    }
    ...
    miku_json_val_t *mar_ok = miku_json_create_object();
    miku_json_object_set(mar_ok, "conversationID", miku_json_create_str(cid));
    miku_json_object_set(mar_ok, "userID", miku_json_create_str("a"));
    miku_msg_handle_rpc(msg, "markMsgAsRead", mar_ok, resp);
    mk_assert_int_eq(0, (int)miku_json_int(miku_json_get(resp, "errCode")));
    miku_json_destroy(mar_ok);
    miku_msg_handle_rpc(msg, "markMsgAsRead", bad, resp);
    mk_assert_int_eq(400, (int)miku_json_int(miku_json_get(resp, "errCode")));
    {
        miku_json_val_t *d = miku_json_get(resp, "data");
        mk_assert(!d || miku_json_type(d) == MK_JSON_NULL);
...
static void test_msg_rpc_delete_resp_reuse(void) {
    ...
    miku_json_val_t *clear_ok = miku_json_create_object();
    miku_json_object_set(clear_ok, "conversationID", miku_json_create_str(cid));
    miku_json_object_set(clear_ok, "userID", miku_json_create_str("a"));
    miku_msg_handle_rpc(msg, "clearConversationMsg", clear_ok, resp);
    mk_assert_int_eq(0, (int)miku_json_int(miku_json_get(resp, "errCode")));
    mk_assert_int_eq(1, (int)miku_json_int(miku_json_get(resp, "deleted")));
    miku_json_destroy(clear_ok);
    miku_msg_handle_rpc(msg, "clearConversationMsg", bad, resp);
    mk_assert_int_eq(400, (int)miku_json_int(miku_json_get(resp, "errCode")));
    {
        miku_json_val_t *del = miku_json_get(resp, "deleted");
        mk_assert(!del || miku_json_type(del) == MK_JSON_NULL);
    }

    send_req = miku_json_create_object();
    miku_json_object_set(send_req, "sendID", miku_json_create_str("a"));
    miku_json_object_set(send_req, "recvID", miku_json_create_str("b"));
    miku_json_object_set(send_req, "content", miku_json_create_str("del4"));
    miku_json_object_set(send_req, "clientMsgID", miku_json_create_str("del-cmid-4"));
    send_resp = miku_json_create_object();
    miku_msg_handle_rpc(msg, "send", send_req, send_resp);
    mk_assert_int_eq(0, (int)miku_json_int(miku_json_get(send_resp, "errCode")));
    miku_json_destroy(send_req);
    ...
    miku_json_val_t *uall_ok = miku_json_create_object();
    miku_json_object_set(uall_ok, "userID", miku_json_create_str("a"));
    miku_msg_handle_rpc(msg, "userClearAllMsg", uall_ok, resp);
    mk_assert_int_eq(0, (int)miku_json_int(miku_json_get(resp, "errCode")));
    mk_assert_int_eq(1, (int)miku_json_int(miku_json_get(resp, "deleted")));
    miku_json_destroy(uall_ok);
    miku_msg_handle_rpc(msg, "userClearAllMsg", bad, resp);
    mk_assert_int_eq(400, (int)miku_json_int(miku_json_get(resp, "errCode")));
    {
        miku_json_val_t *del = miku_json_get(resp, "deleted");
        mk_assert(!del || miku_json_type(del) == MK_JSON_NULL);
...
static void test_msg_rpc_gate_resp_reuse(void) {
    miku_friend_service_t *friends = miku_friend_service_create();
    miku_msg_service_t *msg = miku_msg_service_create();
    miku_msg_service_set_friend_svc(msg, friends);
    mk_assert_int_eq(0, miku_friend_add(friends, "a", "b", ""));
    ...
    miku_json_object_set(send_req, "sendID", miku_json_create_str("a"));
    miku_json_object_set(send_req, "recvID", miku_json_create_str("b"));
    miku_json_object_set(send_req, "content", miku_json_create_str("gate"));
    miku_json_val_t *send_resp = miku_json_create_object();
    miku_msg_handle_rpc(msg, "send", send_req, send_resp);
    mk_assert_int_eq(0, (int)miku_json_int(miku_json_get(send_resp, "errCode")));
    miku_json_destroy(send_req);
    ...
    miku_json_val_t *resp = miku_json_create_object();
    miku_json_val_t *read_ok = miku_json_create_object();
    miku_json_object_set(read_ok, "conversationID", miku_json_create_str(cid));
    miku_json_object_set(read_ok, "userID", miku_json_create_str("a"));
    miku_msg_handle_rpc(msg, "getMsgByConv", read_ok, resp);
    mk_assert_int_eq(0, (int)miku_json_int(miku_json_get(resp, "errCode")));
    mk_assert_not_null(miku_json_get(resp, "data"));

    miku_json_val_t *intruder = miku_json_create_object();
    miku_json_object_set(intruder, "conversationID", miku_json_create_str(cid));
    miku_json_object_set(intruder, "userID", miku_json_create_str("intruder"));
    miku_msg_handle_rpc(msg, "markMsgsAsRead", intruder, resp);
    ...
    mk_assert_int_eq(0, (int)miku_json_int(miku_json_get(resp, "errCode")));
    mk_assert_not_null(miku_json_get(resp, "data"));
    miku_msg_handle_rpc(msg, "setConversationHasReadSeq", intruder, resp);
    mk_assert_int_eq(3003, (int)miku_json_int(miku_json_get(resp, "errCode")));
    {
        miku_json_val_t *d = miku_json_get(resp, "data");
        mk_assert(!d || miku_json_type(d) == MK_JSON_NULL);
    ...
    mk_assert_int_eq(0, (int)miku_json_int(miku_json_get(resp, "errCode")));
    mk_assert_not_null(miku_json_get(resp, "data"));
    miku_msg_handle_rpc(msg, "markConversationAsRead", intruder, resp);
    mk_assert_int_eq(3003, (int)miku_json_int(miku_json_get(resp, "errCode")));
    {
        miku_json_val_t *d = miku_json_get(resp, "data");
        mk_assert(!d || miku_json_type(d) == MK_JSON_NULL);
    ...
    mk_assert_int_eq(0, (int)miku_json_int(miku_json_get(resp, "errCode")));
    mk_assert_not_null(miku_json_get(resp, "data"));
    miku_msg_handle_rpc(msg, "setMessageReactionExtensions", intruder, resp);
    mk_assert_int_eq(3003, (int)miku_json_int(miku_json_get(resp, "errCode")));
    {
        miku_json_val_t *d = miku_json_get(resp, "data");
        mk_assert(!d || miku_json_type(d) == MK_JSON_NULL);
    ...
    mk_assert_int_eq(0, (int)miku_json_int(miku_json_get(resp, "errCode")));
    mk_assert_not_null(miku_json_get(resp, "data"));
    miku_msg_handle_rpc(msg, "addMessageReactionExtensions", intruder, resp);
    mk_assert_int_eq(3003, (int)miku_json_int(miku_json_get(resp, "errCode")));
    {
        miku_json_val_t *d = miku_json_get(resp, "data");
        mk_assert(!d || miku_json_type(d) == MK_JSON_NULL);
    ...
    mk_assert_int_eq(0, (int)miku_json_int(miku_json_get(resp, "errCode")));
    mk_assert_not_null(miku_json_get(resp, "data"));
    miku_msg_handle_rpc(msg, "deleteMessageReactionExtensions", intruder, resp);
    mk_assert_int_eq(3003, (int)miku_json_int(miku_json_get(resp, "errCode")));
    {
        miku_json_val_t *d = miku_json_get(resp, "data");
        mk_assert(!d || miku_json_type(d) == MK_JSON_NULL);
    ...
    mk_assert_int_eq(0, (int)miku_json_int(miku_json_get(resp, "errCode")));
    mk_assert_not_null(miku_json_get(resp, "data"));
    miku_msg_handle_rpc(msg, "markMsgAsRead", intruder, resp);
    mk_assert_int_eq(3003, (int)miku_json_int(miku_json_get(resp, "errCode")));
    {
        miku_json_val_t *d = miku_json_get(resp, "data");
        mk_assert(!d || miku_json_type(d) == MK_JSON_NULL);
...
static void test_msg_delete_rpc_validation(void) {
    miku_msg_service_t *msg = miku_msg_service_create();
    mk_assert_not_null(msg);
    miku_json_val_t *req = miku_json_create_object();
    miku_json_val_t *resp = miku_json_create_object();
    miku_msg_handle_rpc(msg, "deleteMsg", req, resp);
    mk_assert_int_eq(400, (int)miku_json_int(miku_json_get(resp, "errCode")));
    miku_msg_handle_rpc(msg, "deleteMsgPhysical", req, resp);
    mk_assert_int_eq(400, (int)miku_json_int(miku_json_get(resp, "errCode")));
    miku_msg_handle_rpc(msg, "deleteMsgPhysicalBySeq", req, resp);
    mk_assert_int_eq(400, (int)miku_json_int(miku_json_get(resp, "errCode")));
    miku_json_destroy(req);
    miku_json_destroy(resp);
    miku_msg_service_destroy(msg);
...
static void test_msg_get_rpc_validation(void) {
    miku_msg_service_t *msg = miku_msg_service_create();
    mk_assert_not_null(msg);
    miku_json_val_t *req = miku_json_create_object();
    miku_json_object_set(req, "userID", miku_json_create_str("u1"));
    miku_json_val_t *resp = miku_json_create_object();
    miku_msg_handle_rpc(msg, "getMsg", req, resp);
    mk_assert_int_eq(400, (int)miku_json_int(miku_json_get(resp, "errCode")));
    miku_json_destroy(req);
    miku_json_destroy(resp);
...
static void test_msg_conv_read_rpc_validation(void) {
    ...
    miku_json_val_t *seqs_bad = miku_json_create_object();
    miku_json_val_t *seqs_bad_resp = miku_json_create_object();
    miku_msg_handle_rpc(msg, "getConversationsHasReadAndMaxSeq", seqs_bad, seqs_bad_resp);
    mk_assert_int_eq(400, (int)miku_json_int(miku_json_get(seqs_bad_resp, "errCode")));
    ...
    miku_msg_handle_rpc(msg, "getMsgByConv", by_conv_bad, by_conv_bad_resp);
    mk_assert_int_eq(400, (int)miku_json_int(miku_json_get(by_conv_bad_resp, "errCode")));
...
static void test_api_configure_rpc_drops_conv_msg(void) {
    miku_service_config_t sc;
    memset(&sc, 0, sizeof(sc));
    strncpy(sc.rpc_host, "127.0.0.1", sizeof(sc.rpc_host) - 1);
    sc.rpc_conversation_port = 10240;
    sc.rpc_msg_port = 10300;
...
static void test_api_remote_read_acl_defers(void) {
    miku_api_ctx_t *ctx = miku_api_ctx_create();
    mk_assert_not_null(ctx);
    mk_assert_not_null(ctx->friend_svc);

    mk_assert_int_eq(0, miku_api_may_view_user_for_test(ctx, 1, "alice", "bob"));
    mk_assert_int_eq(0, miku_api_may_access_conv_for_test(ctx, "alice", "si_bob"));
    ...
    mk_assert_int_eq(1, miku_api_may_view_user_for_test(ctx, 1, "alice", "bob"));
    mk_assert_int_eq(1, miku_api_may_access_conv_for_test(ctx, "alice", "si_bob"));
    mk_assert_int_eq(1, miku_api_may_access_conv_for_test(ctx, "alice", "sg_g1"));
